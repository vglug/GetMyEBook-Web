...
from cps.forum.apps.settings.form import AccountForm, ChangePasswordForm
...
def index():
    ...
    return render_template("forum_settings.html", form=account_form)
...
def password():
    ...
    return render_template("forum_password.html", form=password_form)
