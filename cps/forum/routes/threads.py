...
from cps.models.forum import Thread, Category, Emoji
...
def create():
    ...
    return render_template("forum_create.html", form=thread_form, book_id=book_id)
...
def show(category_slug, thread_slug):
    ...
    return render_template("forum_show.html",
                        thread=thread, 
                        book=book,
...
def edit(category_slug, thread_slug):
    ...
    return render_template("forum_edit.html", thread=thread, form=thread_form)
