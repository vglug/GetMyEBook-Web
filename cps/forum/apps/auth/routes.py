...
from cps.forum.apps.auth.form import RegistrationForm
from cps.forum.apps.auth.form import LoginForm
from cps.forum import bcrypt
from cps.forum.database.models.user import User
from cps.forum.src.utilities.functions import generate_random_str
from cps.forum.src.utilities.helpers import now
from cps.forum.src.mails.registration_mail import RegistrationMail
